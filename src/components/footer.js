        ...
        <div className="flex flex-col justify-start items-start w-full h-full bg-white drop-shadow-md px-10 py-12 lg:px-24">
            <div className="flex flex-col justify-start items-start w-full h-full gap-3 lg:w-1/2">
                ...
                <p className="text-xl font-light">
                    Since the launch of Marina, Ouckah has captivated solvers by providing engaging word and logic games. In 2022, we introduced Guessia. Today, we proudly added Conexiones to the games made by Ouckah for his girlfriend to play. 
                </p>
            </div>
        </div>
    )
